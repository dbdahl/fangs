...
#[roxido]
fn compute_expected_loss(Z: Robj, Zs: Robj, nCores: Robj) -> Robj {
    Robj::nil()
}
...
#[roxido]
fn fangs(Zs: Robj, nIterations: Robj, maxNFeatures: Robj, nCandidates: Robj, nBests: Robj, nCores: Robj, quiet: Robj) -> Robj {
    Robj::nil()
}
*/
